...
class CharlieStoreApp {
    ...
    generateFakeWarehouseLocation(centerLat, centerLng) {
        ...
        // Marker sizes (updated to match mapManager.js 60px sizing)
        ...
        if (isMobile) {
            ...
            screenX = edgeX - 30; // Move left by 30px (no horizontal change)
            screenY = edgeY - markerRadius - 100; // Move up by marker radius + 100px (95 + 5 more up)
        } else {
    ...
    addCartMarker(userCoordinates) {
        ...
        if (isMobile) {
            ...
            screenX = edgeX - markerRadius + 10; // Move right by 10px from previous position
            screenY = edgeY - markerRadius - 65; // Move up by marker radius + 65px (60 + 5 more up)
        } else {
            ...
            screenX = edgeX + markerRadius + 150; // Adjust for marker size + move 150px right
    ...
    addAccountMarker(cartX, cartY) {
        ...
        if (isMobile) {
            ...
            // Desktop: 350px directly below cart marker
            accountX = cartX;
            accountY = cartY + 350;
        }
