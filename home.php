<?php
/**
 * Home Page Template - Landing Page
 * This is the main landing page for Charlie's Ecommerce
 */
            ...
            <div class="charlies-container">
                ...
                <div class="charlies-categories-grid">
                    ...
                    if ($product_categories) :
                        ...
                        <p>No product categories found. <a href="<?php echo admin_url('edit-tags.php?taxonomy=product_cat&post_type=product'); ?>">Add some categories</a> to get started.</p>
                    <?php endif; ?>
                </div>
            </div>
        </section>
